...
> Última actualización: **2026-04-27** por Ricardo (con Claude) — Sprint 5A y 5B mergeados, 5C esperando merge.

## Resumen ejecutivo

Sprints 1, 1B, 2, 3, 4, **5A y 5B mergeados** en `main`. **Sprint 5C** abierto esperando review/merge. Sprint 5D (SMTP real) pospuesto hasta abrir cuenta SendGrid. Sin contrato firmado con Lezama: no tocamos producción ni abrimos cuentas de pago.

## Ramas activas

| Rama | Estado | PR | Notas |
|---|---|---|---|
| `main` | hasta `2bbf8da` (Sprint 5B mergeado) | — | Estable. |
| `feat/sprint5c-mobile-upload` | rebased sobre main, esperando merge | **PR #17** | `/receipts` responsive <640px, `capture="environment"`. |
...
### Sprint 5C — Móvil responsive (PR #17, rama actual)
...
| **5C** | rebased, listo para merge (PR #17) | `/receipts` responsive <640px |
